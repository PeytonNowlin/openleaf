# @openleaf-editor/angular

Angular wrapper for the OpenLeaf custom element.
...
```sh
npm install @openleaf-editor/angular@beta
```
...
you are not using Angular, skip this package -- the element works on its own
