 ...
 *
 * Styles live as a string in `styles.ts` so the constructable-stylesheet path
 * and the linked-file path cannot drift. This copies that string into
 * `dist/openleaf.css` after `tsc`, which is what
 * `@openleaf-editor/ui/openleaf.css` points at.
 */
import { writeFileSync } from 'node:fs'
import { fileURLToPath } from 'node:url'
import { CSS } from '../dist/styles.js'
