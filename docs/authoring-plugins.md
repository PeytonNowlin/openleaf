...
|---|---|---|
| 100 | `NEVER_PRESERVE` drop rules — `script`, `form`, `input`, `button`, `select`, `textarea`, `link`, `meta`, `template`, and more | Element **and its contents** are discarded |
